...
class _DescriptionPageState extends State<DescriptionPage> {
  ...
  Future<void> addToCart() async {
    ...
    String sizeStr = (selectedSize ?? 32).toString();
    String colorHex = _colorToHex(selectedColor ?? Colors.teal);
    String uniqueCartItemId = '${widget.product['id']}_$sizeStr\_$colorHex';

    final cartRef = FirebaseFirestore.instance
        .collection('users')
        .doc(user.uid)
        .collection('cart')
        .doc(uniqueCartItemId);
